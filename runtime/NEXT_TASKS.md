...
4. Build the UI Today action surface on top of `/api/v1/today`, keeping the existing daily dashboard and briefing surfaces in sync.
5. Add a UI "wat is er veranderd" surface that calls `/briefing/:id/diff` from the reports/briefing history flow.
